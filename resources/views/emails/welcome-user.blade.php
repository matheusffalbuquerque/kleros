        ...
        <tr>
            <td style="padding:20px 24px;">
                ...
                <p style="margin:0 0 12px 0; color:#475569; line-height:1.6;">
                    ...
                    @php
                        $webappUrl = optional($congregacao)->dominio
                            ? 'https://' . optional($congregacao)->dominio . '/webapp'
                            : rtrim(config('app.url'), '/') . '/webapp';
                    @endphp
                    <a href="{{ $webappUrl }}" style="color:#2563eb; font-weight:700; text-decoration:none;">{{ url('/webapp') }}</a>
                </p>
